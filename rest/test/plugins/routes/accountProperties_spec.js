...
// 	pluginTest.assertThat.pluginCreatesDb(plugin, NamespaceDb);
// 	pluginTest.assertThat.pluginDoesNotRegisterAdditionalTransactionStates(plugin);
// 	pluginTest.assertThat.pluginDoesNotRegisterAdditionalMessageChannels(plugin);
